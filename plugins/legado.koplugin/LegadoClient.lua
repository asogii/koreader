...
function LegadoClient:register(username, password)
...
function LegadoClient:authorize(username, password)
    self.client:reset_middlewares()
    self.client:enable("Format.JSON")
    self.client:enable("GinClient")
...
function LegadoClient:update_progress(
        username,
        password,
        document,
        progress,
...
function LegadoClient:get_progress(
        username,
        password,
        document,
        callback)
